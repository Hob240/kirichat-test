...
export default function FrameworkNewPage() {
  ...
  const closeToAgents = () => router.push(`/dashboard/${ws}/agents`);

  useEffect(() => {
    const onKeyDown = (e: KeyboardEvent) => { if (e.key === "Escape") closeToAgents(); };
          ...
          <div className="px-[64px] py-[32px] bg-[#FAFAFA] rounded-b-[16px]">
            ...
            <div className="pt-6">
              <button
                ...
                onClick={() => {
                  // TODO: submit create framework action here
                  closeToAgents();
                }}
              >
